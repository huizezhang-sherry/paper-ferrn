...
\textcolor{red}{We keep the term "1D bases" and "2D basis" in the paper since 1) "frame" is conventinally "basis", and 2) we use this term also in the software. To make this clearer, a sentence is added at the end of section "Projection pursuit guided tour" to note this.}
