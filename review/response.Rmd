...
\textcolor{green}{Thanks for sharing your interpretation of the effects of flipping, that's right!...}
...
\textcolor{green}{However, to avoid ambiguity --> However, to avoid ambiguity}
