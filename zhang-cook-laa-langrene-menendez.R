...
## ----toy-pca-animated-interactive, out.extra="class = 'gif'", fig.cap = "Animated version of Figure 4. With animation, the progression of the search paths from start to finish can better identified and CRS (brown) finishes the optimisation quicker than PD (green).", eval=knitr::is_html_output()----
#> NA
