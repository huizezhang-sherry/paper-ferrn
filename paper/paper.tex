...
three iteration spans the vast majority of the plotting space leaving
the first few iterationsbeing squeezed together whilst the lower plot
spaces each iteration evenly and present summary information easy to
read.}
\end{figure}
...
Figure \ref{toy-interp} shows the plot of interpolating points and it
shows the algorithm starts from around 0.8 and with interpolation,
gradually reaches over 0.95.
...
\hypertarget{explore-the-searching-space}{%
\subsubsection{Explore the searching
space}\label{explore-the-searching-space}}
