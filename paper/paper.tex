...
\ref{tour} reviews projection pursuit guided tour, form the introduces
the optimisation problem, and introduces three main existing algorithms.
...
Section \ref{application} shows some examples of how the diagnostic
plots designed in section \ref{vis-diag} can be applied to understand
and compare different algorithms and how they contribute to
modifications that improve the algorithms. Finally, Section
\ref{implementation} describes the R package: ferrn, that implements all
the visual diagnostics above.

\hypertarget{optim}{%
\section{Derivative free optimisation}\label{optim}}
...
\subsection{Visual diagnostic plots}\label{vis-diag-plots}}
