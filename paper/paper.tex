...
\emph{Toy example} A toy example is shown in Figure \ref{toy-interp}.
...
\emph{A toy example: understand different stage of search\_geodesic}
...
current basis and then the procedures continues. A toy example is shown
in Figure \ref{toy-pca}.
