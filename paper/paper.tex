...
\caption{A selected number of frames from the animated PCA plot. With animation, it is easier to track the progrssion from the start to finish in each algorithm.}\label{fig:toy-pca-animated}
\end{figure}
