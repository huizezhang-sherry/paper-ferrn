...
better understand the performance of the optimisers in practice. This
...
Optimization methods can be divided in various classes (NOTE: do we want
one more sentence on various class: global optim, convex optim,
stochastic optim etc?)
\citep{kelley1999iterative, boyd2004convex, fletcher2013practical}. In
this paper, we focused on methods that rely on the objective function
...
\CRANpkg{stats} \citep{stats} package, which have functions for both
