...
tour. The methods are implemented in the package \pkg{ferrn}, and
changes were made in the \pkg{tourr} package to generate the necessary
data. This work complements with the work of \citet{laa2020using} and
will be useful for researchers when designing new projection pursuit
indexes.
