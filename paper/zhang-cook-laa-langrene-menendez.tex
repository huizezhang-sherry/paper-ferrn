...
Index functions proposed in the litearture include early indices that
can be categorised by measuring the \(L^2\) distance between the
projection and a normal distribution: Legendre index
