...
\citet{buja2005computational}. Notice that the term \emph{frame} used in
Buja's paper is conventionally called \emph{basis}, which is used in
this paper and the associated software. The aforementioned tour method
has been implemented in the R package \CRANpkg{tourr} \citep{tourr}.

\begin{Schunk}
\begin{figure}

{\centering \includegraphics[width=1\linewidth]{/Users/sherryzhang/Documents/research/paper-ferrn/figs/tour-path} 
...
{\centering \includegraphics[width=0.7\linewidth]{/Users/sherryzhang/Documents/research/paper-ferrn/figs/toy-pca} 
