...
rendering of tour animation. Hence, gradient-based methods are not the
...
{\centering \includegraphics[width=0.7\linewidth]{/Users/hzha400/Documents/PhD/research/paper-tour-vis/figs/tour-path} 
...
the current one. Given an initial value of \(T_0\), the ``temperature''
at iteration \(l\) is defined as \(T(l) = \frac{T_0}{\log(l + 1)}\).
When a candidate basis fails to have an index value larger than the
current basis, SA gives it a second chance to be accepted with
probability
...
{\centering \includegraphics[width=1\linewidth]{/Users/hzha400/Documents/PhD/research/paper-tour-vis/figs/toy-pca} 
