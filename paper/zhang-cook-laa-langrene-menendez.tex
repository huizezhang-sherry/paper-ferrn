...
Several features of this optimisation are worth-noticing. 1) The
optimisation is constrained and the space of the bases is a
...
\caption[The PCA plot of 1D projection problem on the 5-variable dataset, \code{boa5}, using the holes indexwith two optimisers]{The PCA plot of 1D projection problem on the 5-variable dataset, \code{boa5}, using the holes indexwith two optimisers: SA and PD. All the bases in PD has been flipped and a grey dashed line has been annotated to indicate the symmetry of two starting bases.}\label{fig:toy-pca}
\end{figure}
\end{Schunk}
