...
\caption[One-D projection of \code{norm\_kol} index on \code{boa6} data optimised by \code{search\_better}, starting from 20 different seeds]{One-D projection of \code{norm\_kol} index on \code{boa6} data optimised by \code{search\_better}, starting from 20 different seeds. }\label{fig:kol-result}
\end{figure}
\end{Schunk}
...
maximum happens when variable \texttt{x7} is found.
