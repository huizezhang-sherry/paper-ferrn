...
happens because the projection is invariate to the sign difference of
...
alpha and color, are applicable to emphasize the crucial elements and
...
Animation is another display to show how the search porgresses from
...
\hypertarget{fliping-the-sign-in-the-bases}{%
\subsection{fliping the sign in the
bases}\label{fliping-the-sign-in-the-bases}}
