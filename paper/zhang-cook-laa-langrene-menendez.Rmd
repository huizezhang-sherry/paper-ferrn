...
```{r toy-tour-interactive, fig.cap="Animating the two paths from Figure \\ref{fig:toy-pca} and \\ref{fig:toy-pca-animated} in the full basis space. The full basis space in this example is a 5D unit sphere, on which points (grey) are randomly generated via the CRAN package geozoo."}
```
