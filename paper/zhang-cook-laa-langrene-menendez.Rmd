...
<<<<<<< HEAD
This paper has provided several visual diagnostics that can be used for diagnosing a complex optimisation procedure. The methods were illustrated using the optimisers available for projection pursuit guided tour. The methods are implemented in the package \pkg{ferrn}, and changes were made in the \pkg{tourr} package to generate the necessary data. This work complements with the work of @laa2020using and will be useful for researchers when designing new projection pursuit indexes.
=======
...
>>>>>>> d4a86b629b7de269c66258f31922fb6c96e5a513
