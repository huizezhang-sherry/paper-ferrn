...
Section \ref{application} shows applications of how these diagnostic plots can be used to examine the performance of different optimisers and guide improvements to the existing algorithms.
Finally, Section \ref{implementation} describes the R package: \CRANpkg{ferrn} [@ferrn], that implements the visual diagnostics.
