...
```{r toy-pca, fig.height=6, fig.cap = "The PCA plot of 1D projection problem on the 5-variable dataset, \\code{boa5}, using the holes indexwith two optimisers: SA and PD. All the bases in PD has been flipped and a grey dashed line has been annotated to indicate the symmetry of two starting bases."}
```
