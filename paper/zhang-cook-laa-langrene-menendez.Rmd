...
```{r toy-pca, fig.height=3, fig.cap = "1D projection on the 5-variable dataset \\code{boa5} with two optimisers: pseudo derivative and simulated annealing. All the bases in pseudo derivative has been flipped positive so that the two paths finish close to each other and to the theoretical best."}
```
