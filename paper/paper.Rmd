...
animate(ani, nframes = 350)
anim_save(ani, nframes = 350, filename = "figures/animated_pca_1d")
```
...
pal <- c("#D3D3D3","#D95F02","#7570B3", "#E7298A")
...
cex <- c(rep(1, nrow(sphere)),
         rep(2, nrow(path1)), 
         rep(2, nrow(path2)))
#save_history(animate_xy(dt, col = color, cex = cex))

# save history and play to find the view similar to the PCA view 

animate_slice(dt, col = color, pch_other = 20)
