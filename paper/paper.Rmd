...
When plotting the searching observations as points in a plot, the space each iteration take will be proportional to the number of points in that iteration.
