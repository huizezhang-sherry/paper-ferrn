...
Below we will present several examples to diagnose different aspects of the projection pursuit optimisation. We will present:  

1) static plots to explore the index value,

2) animated plots to explore the projection basis and,  

3) a self-contained example to understand how to optimise a noisy and complex index function. 
